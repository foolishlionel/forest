...
extension Date {
    ...
    /// Create a new instance representing `TODAY`.
    ///
    ...
    /// Creates a new instance by change the month.
    ///
    /// - parameter month: The month.
    ///
    /// - returns: The created `Date` instance.
    ...
    /// Creates a new instance by changin the nanosecond.
    ///
    /// - parameter nanosecond: The nanosecond.
    ///
    /// - returns: The created `Date` instance.
    ...
    ///
    /// - parameter components: The components to be truncated(截断).
    ///
    /// - returns: The created `Date` instance.
